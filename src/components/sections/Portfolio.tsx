      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-10">
        ...
        <div ref={rootRef} className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {portfolio.map((item) => (
            ...
            >
              <div
                className="relative flex aspect-[4/3] flex-col justify-end overflow-hidden p-7 transition-transform duration-700 ease-[var(--ease-move)] group-hover:scale-[1.04] sm:p-9"
                style={{
